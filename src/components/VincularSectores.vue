<template>
  ...
  <div class="headerVincularSector">
            ...
            <div class="table-responsive">
              <table class="table user-list">
                ...
                <tr>
                  ...
                  <th><span style="font-size:25px;font-weight:bold;">Elija un sector</span> </th>
                  <th>  </th>
                </tr>
                </thead>
                ...
                <tr v-for="org in organizaciones" v-bind:key = "org.id">
                  <td> <!-- columna de id de usuario -->
                    <img src="../assets/personita.png" height="" width="" alt="">
                    <p class="user-link"> <strong> {{org.idOrganizacion}} </strong></p>
                  </td>

                  <td> <!-- columna de nombre de usuario -->
                    <p class="razonSocial"> <strong> {{org.razonSocial}}</strong></p>
                  </td>

                  <!-- un select que traiga todas los sectores de un repo-->
                  ...
                  <td style="width: 20%;" class="botones"> <!-- columna de botones -->
                    <button type="button" class="btn btn-sm" @click="this.vincularSector(org.idOrganizacion, sectorElegido)">Vincular Sector a Org</button>
                  </td>
...
export default {
  ...
  methods: {
    ...
    vincularSector: function vincularSector(idOrganizacion, sector) {
      let idSector = sector.split(" - ")[0];
      vinculoSectoresService.vincularSector(idOrganizacion, idSector).then(response => {
