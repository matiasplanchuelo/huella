  ...
  <body class="bodyCrearSector">
    ...
    <div class="headerCrearSector">
      ...
      <div class="inner-header flex titulo">
        ...
        <h1>Agregar nuevos sectores territoriales</h1>
      ...
      <form class="CrearSector">
        ...
        <label for="text">Tipo Sector</label>
        <select name="tipoOrg" id="tipoOrg" v-model="tipoSector">
        ...
        <br>
        <!--BOTON-->
        <input class="btnCrearSector" type="button" value="Agregar Sector" @click="agregarSector">
...
import crearSectorTerritorialService from "@/services/crearSectorTerritorialService";
...
export default {
  ...
  methods: {
    agregarSector() {
      alert("Se agregó el sector" + " -> " +this.nombre + " de tipo: " + this.tipoSector);
      crearSectorTerritorialService.crearSector(this.tipoSector.toUpperCase(), this.nombre);
    },
